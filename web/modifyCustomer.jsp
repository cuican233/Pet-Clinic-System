...
<form action="CustomerServlet" method="post" class="form-horizontal" role="form">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
            <input type="text" class="form-control" id="name" placeholder="原姓名：<%=user.getName()%>" name="nname">
            <input type="hidden" name="oname" value="<%=user.getName()%>">
        </div>
    </div>
    <div class="form-group">
        <label for="tel" class="col-sm-2 control-label">客户电话：</label>
        <div class="col-sm-7">
            <input type="text" class="form-control" id="tel" placeholder="请输入修改后电话" name="tel">
        </div>
    </div>
    <div class="form-group">
