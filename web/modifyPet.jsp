...
<form action="PetServlet" method="post" enctype="multipart/form-data" class="form-horizontal" role="form"> <!-- 文件上传  要修改表单的enctype属性 -->
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
            <input type="text" class="form-control" id="name" placeholder="原宠物名称：<%=pet.getName()%>" name="name">
            <input type="hidden" name="oname" value="<%=pet.getName()%>">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
            <input type="text" class="form-control" id="birthdate" placeholder="请输入修改后宠物生日" name="birthdate">
        </div>
    </div>
    <div class="form-group">
