...
//			事务2.在操作完成后手动提交
    ...
    public void update(Vet vet) throws Exception
    {
        Connection con = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        ...
        try
        {
            ...
            ps = con.prepareStatement("select id from t_vet where name=?");
            ps.setString(1, vet.getName());
            rs = ps.executeQuery();
            if (rs.next()){
                vet.setId(rs.getInt(1));
            ...
            ps = con.prepareStatement("delete from t_vet_speciality where vetId=?");
    ...
    public Vet getById(int id) throws Exception{
        Vet vet=null;
        ...
        try {
            ...
            Class.forName("com.mysql.jdbc.Driver");
            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_ph?useUnicode=true&characterEncoding=UTF-8","root","cuican233");
            ps=con.prepareStatement("select * from t_vet where id=?");
            ps.setInt(1, id);
            rs=ps.executeQuery();
